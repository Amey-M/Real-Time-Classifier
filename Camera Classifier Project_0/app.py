...
class App:
    ...
    def __init__(self, window = tk.Tk(), window_title = "Amey's Real-time Classifier"):
    ...
    def init_gui(self):
        ...
        self.btn_pedict = tk.Button(self.window, text="Predict", width=50, command=lambda: self.predict)
        self.btn_pedict.pack(anchor=tk.CENTER, expand=True)
    ...
    def save_for_class(self, class_num):
        ...
        self.counters[class_num -1] = self.counters[class_num -1] + 1
